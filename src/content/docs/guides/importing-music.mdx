...
1. Import this file into HeyTCM by clicking `Music` → `Import MusicXML`
...
I invite you to use HeyTCM's many shortcomings as opportunities to hack your way through and figure out how you can make it work 🙂.
