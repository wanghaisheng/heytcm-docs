...
description: "Beginner guide to HeyTCM"
---

import { Steps } from '@astrojs/starlight/components';

Welcome to HeyTCM! Make sure to [download](/download) and install the app if you haven't already.
...
Please also report any bugs you encounter in the [GitHub](https://github.com/HeyTCM/HeyTCM/issues) by making an issue, or the Discord.
